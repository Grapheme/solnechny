			...
			<?php $this->load->view("guests_interface/includes/navigation");?>
				<article>
					...
					<div class="page-title">
						В десяти километрах от Ростова-на-Дону вы найдете море летних развлечений для взрослых и детей всех возрастов. 
						Подогреваемые бассейны, площадки для пляжных игр, приватные беседки, диджей-бар и уютный ресторан с европейской кухней и детским меню. 
						Загородный клуб «Солнечный» — ваше место под солнцем!
					</div>
					<div class="grid2 page-main-text" style="display: table">
						<div class="col text">
							Экологичный интерьер и первоклассный сервис оценят поклонники семейного отдыха. Не дожидаясь отпуска, вы 
							можете провести время на природе с городским комфортом. Зарядиться солнечной энергией в окружении ярких, 
							интересных людей. Позагорать в шезлонге у бассейна или поиграть в пляжный волейбол. Теплой компанией растянуться 
							на «vip-матрасе» в беседке, а вечером поужинать на террасе и послушать выступления любимых музыкантов.
						</div>
						<div class="col">
							Детей и родителей порадует детский клуб с возможностью оставить ребенка на целый день.
							Под присмотром опытных педагогов и аниматоров дети занимаются творчеством, строят песочные замки, катаются с горки в мини-бассейне и 
							заняты множеством других интересных дел. Что бы вы ни выбрали, в «Солнечном» вас ждут идеальные летние выходные.
						</div>
					</div>
