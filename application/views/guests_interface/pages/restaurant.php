			...
			<div class="white-div">
				...
				<article>
					...
					<div class="grid2 page-main-text" style="display: table">
						<div class="col text">
							Двухуровневый ресторан с открытой террасой на 260 гостей прекрасно подходит как для камерных ужинов, так и для пышных торжеств. 
							Светлый, лаконичный интерьер выдержан в природной цветовой гамме. Мягкие кресла, «необработанные » деревянные поверхности и обилие живых 
							растений дают ощущение свежести и умиротворения. В меню традиционные блюда европейской и итальянской кухни.
						</div>
						<div class="col">
							Для детей, кроме любимой пиццы и пасты, большой выбор диетических блюд из детского меню, всевозможные салаты, фреши и десерты из сезонных 
							фруктов и ягод. Для взрослых – профессиональная дегустация вин от опытного сомелье. Есть зал для курящих, работает высокоскоростной wi-fi. 
							Каждые выходные – живые выступления известных музыкантов, места на которые нужно бронировать заранее.
						</div>
					</div>
