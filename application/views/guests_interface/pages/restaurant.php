				...
				<article>
					...
					<div class="grid2 page-main-text" style="display: table">
						<div class="col text">
							...
							<p>
								Интерьер ресторана уютный и по-домашнему теплый — с плетеными креслами, глубокими мягкими диванами и обилием живых растений.
							</p>
						</div>
						<div class="col">
							<p>
								Мы стремимся позволить посетителям клуба оказаться вне законов времени и насладиться бесподобно вкусными и изысканными обедами или ужинами.
							</p>
							<p>
